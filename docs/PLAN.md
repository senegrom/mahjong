...
| M4, search and Mortal | search is built and runs across every core: worlds imagined from what a seat can see, drawn from what the network believes the opponents hold, played out, and taken only when they beat the player's own choice by two standard errors. At ten worlds it changed 2.7% of decisions and measured level; at forty, 0.097 ahead at 2.3 standard errors; higher counts are being measured. Mortal not started. |
