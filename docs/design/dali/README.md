...
A surrealist tile face set for the mahjong game. Ten faces are approved, drawn from the original studies and Carl's later selections. The latest are seven-characters A, **The Sleeping Seven**, eight-characters B, **The Window in Reality**, and corrected nine-characters C, **Sapphire Suspension**.
...
The other 24 faces use `web/public/tiles/dali/placeholders/placeholder.svg` until they receive approved artwork.
...
Choose **Options → Tile face → Dalí**. The preference is persisted with the existing settings mechanism. All 34 Dali tile identities are included in the preload inventory: ten approved faces plus one shared placeholder for the remaining identities. The option is part of the Svelte settings control, and the tile's hint rings follow the same rounded outline as its artwork.
