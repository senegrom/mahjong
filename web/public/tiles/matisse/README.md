...
## New concepts awaiting review

- [Man7.svg](concepts/Man7.svg): flowing black 七 above red 萬, giving calligraphic style A a place in the character suit.
- [Sou1.svg](concepts/Sou1.svg): a blue and green cut-paper bird on a bamboo perch.
- [Hatsu.svg](concepts/Hatsu.svg): ivory 發 cut out of emerald green, using style C.

These three designs were requested as the next exploration. They are not yet marked approved.

## Preview and exports

Open [preview.html](preview.html) locally, or visit `/tiles/matisse/preview.html` when running the web project. It is a standalone page with embedded artwork, an exact CSS-pixel hand preview at 390 or 844 pixels wide, and a toggle to include the new concepts. The sample hand is for visual comparison only.
...
The script performs only lossless rectangular extraction, canvas wrapping and preview generation. The six approved designs are taken directly from the selected source pixels.
