...
const definitions = [
  ...
  ['Nan', '2z', 'South wind', 'approved', 'south-wind-a-sirocco-approved.png', [8, 7, 1070, 1338], 'Sirocco A: windblown aubergine ribbons form 南 on saffron yellow, with a sweeping ivory top crossbar and two distinct carmine interior bars. The asymmetrical enclosure and curling right hook preserve the character. The lossless crop preserves the selected artwork, excludes the presentation label and surround, and uses the shared 3:4 face, bleed and rounded clipping.'],
...
function draw(){const names=['Man1','Man2','Sou7','Man4','Man5','Man6','Man7','Man8','Man9','Pin1','Sou3','Ton','Nan','Pei'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
