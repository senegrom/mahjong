...
const definitions = [
  ...
  ['Pin5', '5p', '5 disks', 'approved', 'five-disks-full-bleed-yellow.png', [0, 0, 1060, 1484], 'Five black disks with ivory cut-paper rosettes on a full-bleed sunflower-yellow field. Yellow reaches every edge of the face, with no ivory rim, bevel or surrounding shadow. The complete flat source is preserved with the shared 3:4 face, bleed and rounded clipping.'],
