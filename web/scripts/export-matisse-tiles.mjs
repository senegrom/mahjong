...
const definitions = [
  ...
  ['Sou3', '3s', '3 bamboo', 'approved', 'three-bamboo-rimless-approved.png', [0, 0, 1086, 1448], 'Approved rim-free update of the original Chasuble B: three ivory jointed bamboo cut-outs, one above two, on edge-to-edge forest green. The complete flat 3:4 artwork has no ivory rim or physical bevel and uses the shared bleed and rounded clipping. Green and neutral ivory preserve the All Green palette.'],
