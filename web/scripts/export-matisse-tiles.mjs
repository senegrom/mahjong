...
function draw(){const names=['Man1','Man2','Sou7','Man4','Sou5','Man6','Man7','Man8','Sou9','Pin1','Sou3','Ton','Nan','Pei'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
