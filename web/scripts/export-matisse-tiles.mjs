...
function draw(){const names=['Man1','Man2','Man7','Pin1','Pin2','Pin3','Pin9','Sou1','Sou2','Sou4','Sou7','Sou9','Ton','Shaa'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
