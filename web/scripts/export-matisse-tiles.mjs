...
function draw(){const names=['Man1','Man2','Man7','Pin2','Pin3','Pin4','Pin6','Pin7','Pin9','Sou1','Sou4','Ton','Shaa','Pei'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
