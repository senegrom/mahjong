...
const definitions = [
  ...
  ['Pin4', '4p', '4 disks', 'approved', 'four-disks-c-approved.png', [1281, 22, 563, 731], 'C: four magenta and yellow cut-paper rosettes with exchanged colours and turquoise centres on a turquoise field.'],
...
function draw(){const names=['Man1','Man2','Man7','Pin1','Pin2','Pin3','Pin4','Pin7','Pin9','Sou1','Sou4','Sou7','Ton','Shaa'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
