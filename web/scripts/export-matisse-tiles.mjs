...
const definitions = [
  ...
  ['Pin5', '5p', '5 disks', 'approved', 'five-disks-five-suns-approved.png', [0, 0, 1086, 1448], 'Five Suns: five distinct cobalt, vermilion, raspberry and mint cut-paper disks dance around an oversized centre on full-bleed sunflower yellow. Varied leaf, pinwheel and crescent counterforms keep all five disks separate and countable. The complete approved 3:4 artwork is preserved, with the shared bleed and rounded clipping and no ivory rim.'],
  ...
  ['Pin9', '9p', '9 disks', 'approved', 'nine-disks-c-red-rhythm-approved.png', [0, 0, 1086, 1448], 'Red Rhythm C: eight lemon-yellow, ivory and mint disks with varied botanical, spiral and lobed cut-outs surround one larger cobalt-blue disk with a curling mint frond on vermilion. Exactly nine complete disks remain distinct and countable. The complete approved 1086 × 1448 source is preserved losslessly, with colour reaching every edge and the shared 3:4 face, bleed and rounded clipping.'],
  ['Sou2', '2s', '2 bamboo', 'approved', 'two-bamboo-c-cut-and-swap-approved.png', [47, 28, 994, 1292], 'Cut & Swap C: two mint and forest-green bamboo cut-outs exchange foreground and background colours across a sweeping divided green field. Every visible part of the face stays green for All Green. The lossless crop preserves both complete forms and excludes the presentation label and surround, using the shared 3:4 face, bleed and rounded clipping with no inset rim.'],
  ['Sou3', '3s', '3 bamboo', 'approved', 'three-bamboo-b-chapel-windows-approved.png', [0, 0, 1086, 1448], 'Chapel Windows B: three deep-forest bamboo silhouettes, one above two, cut through a flowing mint-green field on emerald. Every visible part of the face stays green for All Green. The complete approved 1086 × 1448 source is preserved losslessly, with colour reaching every edge and the shared 3:4 face, bleed and rounded clipping.'],
  ...
  ['Sou5', '5s', '5 bamboo', 'approved', 'five-bamboo-c-cut-and-swap-approved.png', [0, 0, 1086, 1448], 'Cut & Swap C: two mint and two forest-green bamboo cut-outs exchange foreground and background colours across a sweeping divided green field, with a sinuous vermilion fifth stalk. Exactly five complete plants remain separate and countable. The complete approved 1086 × 1448 source is preserved losslessly, with colour reaching every edge and the shared 3:4 face, bleed and rounded clipping removing any ivory rim.'],
  ...
  ['Sou7', '7s', '7 bamboo', 'approved', 'seven-bamboo-a-leap-approved.png', [0, 0, 1086, 1448], 'Leap A: one coral and six green cut-paper forms leap and curl across an electric-blue field. The exact approved blue-background candidate retains seven separate silhouettes. The complete flat 3:4 source is preserved at native resolution, with colour reaching every edge and the shared bleed and rounded clipping removing any white rim.'],
  ...
  ['Sou9', '9s', '9 bamboo', 'approved', 'nine-bamboo-emerald-surround-approved.png', [0, 0, 1090, 1443], 'Emerald surround: the selected green-border revision keeps nine green, ivory and yellow jointed ribbons in three staggered groups on the wavy ultramarine field. Emerald replaces the former ivory surround and fills every outer edge and corner. The complete approved source is preserved at native resolution with the shared 3:4 face, bleed and rounded clipping.'],
  ...
  ['Nan', '2z', 'South wind', 'approved', 'south-wind-d-paper-window-approved.png', [47, 47, 992, 1306], 'Paper Window D: vermilion 南 cut through a sweeping lemon-yellow chasuble, with a blush-pink lower-left shape on vermilion. Both interior horizontal bars remain clear. The lossless crop preserves the selected original artwork, excludes the presentation label and surround, and uses the shared 3:4 face, bleed and rounded clipping with no inset rim.'],
  ...
  ['Man1', '1m', '1 characters', 'approved', 'one-characters-b-rimless-approved.png', [0, 0, 1086, 1448], 'Dance B, approved rimless revision: a sweeping yellow 一 above sculptural vermilion 萬 on deep purple. Purple fills the entire flat face after removal of the old ivory rim. The complete 1086 × 1448 source is exported losslessly with the shared 3:4 face, bleed and rounded clipping.'],
  ['Man2', '2m', '2 characters', 'approved', 'two-characters-jazz-dance-approved.png', [0, 0, 1086, 1448], 'Jazz Dance: vivid coral-vermilion 萬 interlocks with a cobalt sweep and a small magenta accent above two separate yellow and ivory strokes forming 二 on deep purple. The complete flat 1086 × 1448 approved source fills the face without an ivory rim and is exported losslessly with the shared 3:4 face, bleed and rounded clipping.'],
  ['Man3', '3m', '3 characters', 'approved', 'three-characters-a-jazz-rimless-approved.png', [0, 0, 1086, 1448], 'Jazz A, approved rim-free revision: yellow, ivory and pink strokes form 三 above a vermilion-and-pink 萬 with an oversized kicking stroke. Deep purple reaches every edge with no ivory rim or physical bevel. The complete flat 1086 × 1448 artwork is preserved losslessly with the shared 3:4 face, bleed and rounded clipping.'],
  ...
  ['Man7', '7m', '7 characters', 'approved', 'seven-characters-rimless-approved.png', [0, 0, 1086, 1448], 'Approved rim-free update of Cut-out C: pink 萬 at upper left, oversized pale-yellow 七 below and a red accent on edge-to-edge deep purple. The complete flat 3:4 artwork has no ivory rim, physical bevel or surrounding shadow and is preserved at native resolution with the shared bleed and rounded clipping.'],
  ['Man8', '8m', '8 characters', 'approved', 'eight-characters-d-open-wings-approved.png', [0, 0, 1086, 1448], 'Open wings D: two sweeping yellow and coral strokes form 八 below ivory 萬, with a broad cobalt cut-paper field on deep purple. The exact approved candidate is preserved as a complete flat 1086 × 1448 source, with the shared 3:4 face, bleed and rounded clipping and no inset rim. Completes all 34 Matisse tile faces.'],
...
function draw(){const names=['Man1','Man2','Sou7','Man4','Sou5','Pin9','Man7','Man8','Sou9','Pin1','Sou3','Ton','Nan','Pei'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
