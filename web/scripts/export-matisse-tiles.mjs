...
function draw(){const names=['Man1','Man2','Man3','Man4','Man5','Man6','Man7','Man9','Pin4','Pin6','Sou1','Ton','Nan','Pei'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
