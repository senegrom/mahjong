...
function draw(){const names=['Man7','Pin1','Pin2','Pin3','Sou1','Sou2','Sou3','Sou4','Sou5','Sou7','Sou8','Sou9','Ton','Shaa'];rack.replaceChildren(...names.map(name=>picture(byName[name])));table.style.width=document.getElementById('width').value+'px';requestAnimationFrame(updateSize)}
