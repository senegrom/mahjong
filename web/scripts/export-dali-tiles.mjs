...
const hand = ['Pin1', 'Pin1', 'Pin3', 'Pin3', 'Pin5', 'Pin5', 'Sou1', 'Sou2', 'Sou2', 'Sou5', 'Man8', 'Man8', 'Chun', 'Chun'];
...
<main><h1>Dali</h1><p>${manifest.tiles.length} approved faces. Five bamboo uses A — The Soft Grove. Three disks uses B — Time coming apart. Choose Options → Tile face → Dalí in the game. The remaining ${manifest.placeholders.length} tiles use the study placeholder.</p>
