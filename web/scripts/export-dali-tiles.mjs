...
const definitions = [
  ...
  ['Sou5', '5s', '5 bamboo', 'The Soft Grove — A', 'five-bamboo-a-approved.png', [0, 0, 1086, 1448]],
  ['Sou7', '7s', '7 bamboo', 'The Dream Cabinet', 'seven-bamboo-dream-cabinets-approved.svg', [0, 0, 432, 576]],
  ['Sou9', '9s', '9 bamboo', 'The Surreal Grove', 'nine-bamboo-surreal-grove-approved.svg', [0, 0, 300, 400]],
  ['Man5', '5m', '5 characters', 'Theatre of the Impossible — A', 'five-characters-a-approved.png', [0, 0, 1086, 1448]],
  ['Man6', '6m', '6 characters', 'The Runaway Shadow — B', 'six-characters-b-approved.png', [0, 0, 1086, 1448]],
  ['Man7', '7m', '7 characters', 'The Sleeping Seven — A', 'seven-characters-a-approved.png', [0, 0, 1086, 1448]],
  ['Man8', '8m', '8 characters', 'The Window in Reality — B', 'eight-characters-b-approved.png', [0, 0, 1086, 1448]],
  ['Man9', '9m', '9 characters', 'Sapphire Suspension — C', 'nine-characters-c-approved.png', [0, 0, 1086, 1448]],
...
for (const [name, tile, label, direction, sourceName, crop] of definitions) {
  ...
  const raster = sourceName !== board ? sourceBytes : execFileSync('convert', [
...
const hand = ['Pin1', 'Sou7', 'Sou9', 'Pin3', 'Pin5', 'Sou1', 'Sou2', 'Sou5', 'Man5', 'Man6', 'Man7', 'Man8', 'Man9', 'Chun'];
...
<main><h1>Dali</h1><p>${manifest.tiles.length} approved faces. Five characters uses A — Theatre of the Impossible; six characters uses B — The Runaway Shadow. Seven characters uses A — The Sleeping Seven; eight characters uses B — The Window in Reality; nine characters uses the corrected C — Sapphire Suspension. Nine bamboo uses The Surreal Grove — varied green stems, a ruby centre and red leaf accents on a neutral full-bleed landscape. Seven bamboo uses The Dream Cabinet — one ruby and six jade bamboo cabinets. Five bamboo uses A — The Soft Grove. Three disks uses B — Time coming apart. Choose Options → Tile face → Dalí in the game. The remaining ${manifest.placeholders.length} tiles use the study placeholder.</p>
